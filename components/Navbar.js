        ...
        >
          <div className="lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full lg:items-center flex flex-col lg:h-auto">
            <div className="flex lg:space-x-3">
              ...
              <a
                onClick={checkout}
                className="lg:inline-flex cursor-pointer text-xl font-semibold flex lg:w-auto px-3 py-2 rounded text-white lg:items-center hover:bg-gray-600 hover:text-white "
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
